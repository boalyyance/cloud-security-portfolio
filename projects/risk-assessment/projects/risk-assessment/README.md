...
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------- |
| Asset Management           | Asset inventory is incomplete, and critical assets are not properly classified. All employees have access to sensitive information, including cardholder data and personally identifiable information (PII). | 🔴 High     |
...
| Access Control             | Least privilege and Separation of Duties (SoD) principles are not enforced. Password management lacks centralized control.                                                                                   | 🔴 High     |
...
- Implementing a formal risk matrix
